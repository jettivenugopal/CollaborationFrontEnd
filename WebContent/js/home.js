var CollaborationBackEnd=angular.module("CollaborationBackEnd",['ngRoute','ngCookies']);
CollaborationBackEnd.config(function($routeProvider){
	$routeProvider
...
CollaborationBackEnd.directive('fileModel', ['$parse', function ($parse) {
    return {
       restrict: 'A',
...
CollaborationBackEnd.service('fileUpload', ['$http','$location', function ($http,$scope,$location) {
...
CollaborationBackEnd.run( function ($rootScope, $location,$cookieStore, $http) {
...
CollaborationBackEnd.controller('registerController', ['$scope', 'fileUpload', function($scope,fileUpload){
    $scope.register = function(){
       ...
       console.log('file is ' );
       console.dir(file);
       var uploadUrl = "http://localhost:2020/CollaborationBackEnd/fileUpload";
...
CollaborationBackEnd.service("ChatService", function($q, $timeout) {
...
CollaborationBackEnd.controller("chatController",function($scope,$http,ChatService,$rootScope)
		{
	...
	$scope.messages = [];
	  ...
	  ChatService.receive().then(null, null, function(message) {
		...
		CollaborationBackEnd.controller("JobsController",function($scope,$http)
				{
			...
			$scope.addJ=function()
			{
				...
				var res=$http.post("http://localhost:2020/CollaborationBackEnd/addJobs",jobs);
				...
				CollaborationBackEnd.controller("loginController",['$cookieStore','$scope','$http','$location','$rootScope',function($cookieStore,$scope,$http,$location,$rootScope)
						{
					...
					$http.post("http://localhost:2020/CollaborationBackEnd/authenticate",logi).then(function(response)
							{
				...
				CollaborationBackEnd.controller("blogController",function($scope,$http,$rootScope)	
						{
					$rootScope.userhome=true;
					$rootScope.userforum=true;
					$rootScope.userjobs=true;
					...
					$http.get("http://localhost:2020/CollaborationBackEnd/viewMyBlogs/"+$rootScope.uname)
							 ...
							 $scope.newBlog={};
								...
								$scope.addBlog=function(newBlog)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:2020/CollaborationBackEnd/addBlog',dataObj);
									 $http.get("http://localhost:2020/CollaborationBackEnd/viewMyBlogs/"+$rootScope.uname)
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:2020/CollaborationBackEnd/updateBlog",edit);
					$http.get("http://localhost:2020/CollaborationBackEnd/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
				...
				$http.post("http://localhost:2020/CollaborationBackEnd/deleteBlog",del);
					$http.get("http://localhost:2020/CollaborationBackEnd/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
				...
				CollaborationBackEnd.controller("adminBlogController",function($scope,$http,$rootScope)	
						{	
					$rootScope.home=false;
					$rootScope.login=false;
					$rootScope.register=false;
					...
					console.log(" in adminblog controller");
							 ...
							 $http.get("http://localhost:2020/CollaborationBackEnd/viewBlogs")
							    .then(function (response) {
				...
				CollaborationBackEnd.controller("adminJobsController",function($scope,$http,$rootScope)	
						{	
					$rootScope.home=false;
					$rootScope.login=false;
					$rootScope.register=false;
					...
					console.log(" in jobs controller");
							 ...
							 $http.get("http://localhost:2020/CollaborationBackEnd/viewJobs")
							    .then(function (response) {
							 ...
							 $scope.newJobs={};
								...
								$scope.addJobs=function(newJobs)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:2020/CollaborationBackEnd/addJobs',dataObj);
									 $http.get("http://localhost:2020/CollaborationBackEnd/viewJobs")
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:2020/CollaborationBackEnd/updateJob",edit);
					 $http.get("http://localhost:2020/CollaborationBackEnd/viewJobs")
					    .then(function (response) {
				...
				$http.post("http://localhost:2020/CollaborationBackEnd/deleteJob",del);
					 $http.get("http://localhost:2020/CollaborationBackEnd/viewJobs")
					    .then(function (response) {
				...
				CollaborationBackEnd.controller('logoutController',function($scope,$rootScope,$http,$cookieStore)		
						{
					$http.post("http://localhost:2020/CollaborationBackEnd/logout/"+$rootScope.uname);
				...
				CollaborationBackEnd.controller("userJobsController",function($scope,$http,$rootScope)	
						{	
					$rootScope.userhome=true;
					$rootScope.userforum=true;
					$rootScope.userjobs=true;
				...
				CollaborationBackEnd.controller("adminForumController",function($scope,$http,$rootScope)	
						{	
					$rootScope.home=false;
					$rootScope.login=false;
					$rootScope.register=false;
					...
					console.log(" in adminforum controller");
							 ...
							 $http.get("http://localhost:2020/CollaborationBackEnd/viewForums")
							    .then(function (response) {
							 ...
							 $scope.newForum={};
								...
								$scope.addForum=function(newForum)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:2020/CollaborationBackEnd/addForum',dataObj);
									 $http.get("http://localhost:2020/CollaborationBackEnd/viewForums")
				...
				$scope.approveForum=function()
				{
					...
					$http.put("http://localhost:2020/CollaborationBackEnd/updateForum",edit);
					 $http.get("http://localhost:2020/CollaborationBackEnd/viewForums")
					    .then(function (response) {
				...
				CollaborationBackEnd.controller("userForumController",function($scope,$http,$rootScope)	
						{	
					$rootScope.userhome=true;
					$rootScope.userforum=true;
					$rootScope.userjobs=true;
					...
					console.log(" in forum controller");
							 ...
							 $http.get("http://localhost:2020/CollaborationBackEnd/viewForum")
							    .then(function (response) {
							 ...
							 $scope.newForum={};
								...
								$scope.answer=function(forum)
								{
									...
									answer:$scope.answerforum.answer
									 ...
									 $http.post('http://localhost:2020/CollaborationBackEnd/answerForum',ans);
									$http.get("http://localhost:2020/CollaborationBackEnd/viewForum")
								    .then(function (response) {
								...
								$scope.viewanswers=function(forum)
								{
									...
									console.log("forumid:"+$scope.answerforum.forum_id);
									 $http.get("http://localhost:2020/CollaborationBackEnd/viewAnswers/"+$scope.answerforum.forum_id)
									    .then(function (response) {
				...
				$http.post("http://localhost:2020/CollaborationBackEnd/deleteForum",del)
				...
				CollaborationBackEnd.controller("userHomeController",function($scope,$http,$rootScope)	
						{	
					...
					console.log("name in  findfriends:"+$rootScope.uname);
							 $http.get("http://localhost:2020/CollaborationBackEnd/findFriends/"+$rootScope.uname)
							    .then(function (response) {
					...
					$scope.addfriend=function(user)
					{
						...
						$http.post("http://localhost:2020/CollaborationBackEnd/addFriend/",fr);
						
					}
					
						});
				CollaborationBackEnd.controller("friendslistController",function($scope,$http,$rootScope)	
						{	
					$rootScope.userhome=true;
					$rootScope.userforum=true;
					$rootScope.userjobs=true;
					...
					console.log("name in  friendslist:"+$rootScope.uname);
							 $http.get("http://localhost:2020/CollaborationBackEnd/viewFriends/"+$rootScope.uname)
							    .then(function (response) {
				...
				CollaborationBackEnd.controller("allblogsController",function($scope,$http,$rootScope,$route)	
						{	
					$rootScope.userhome=true;
					$rootScope.userforum=true;
					$rootScope.userjobs=true;
					...
					console.log("username in allblog controller:"+$rootScope.title);
							 $http.get("http://localhost:2020/CollaborationBackEnd/viewAllBlogs")
							    .then(function (response) {
							 ...
							 { 
						       ...
						       var like=
								...
								console.log("postedby:"+$rootScope.title);
								 $http.put('http://localhost:2020/CollaborationBackEnd/updateBlog',like);
								 $http.get("http://localhost:2020/CollaborationBackEnd/viewBlogs")
								    .then(function (response) {
					 ...
					 $http.get("http://localhost:2020/CollaborationBackEnd/viewComments/"+$scope.viewcomments.blog_id)
								    .then(function (response) {
						...
						$scope.comment=function(allblogs)
						{
							...
							$http.post('http://localhost:2020/CollaborationBackEnd/addComment',comment);
							 $http.get("http://localhost:2020/CollaborationBackEnd/viewBlogs")
							    .then(function (response) {
